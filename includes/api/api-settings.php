 ...
 * @return		N/A
 */
function hmembership_admin_display_form_element( $args ) {
	...
	switch ( $args[ 'type' ] ) {
		...
		case 'password':
		case 'number':
			hmembership_admin_display_text_form_element( $args );
			break;

		case 'textarea':
			hmembership_admin_display_textarea_form_element( $args );
			break;

		case 'select':
		case 'multiselect':
			hmembership_admin_display_select_form_element( $args );
			break;

		case 'radio':
		case 'checkbox':
			hmembership_admin_display_radio_form_element( $args );
			break;
...
/**
 * hmembership_admin_display_text_form_element
 *
 ...
 * @return		N/A
 */
function hmembership_admin_display_text_form_element( $args ) {
...
/**
 * hmembership_admin_display_textarea_form_element
 *
 ...
 * @return		N/A
 */
function hmembership_admin_display_textarea_form_element( $args ) {
...
/**
 * hmembership_admin_display_select_form_element
 *
 ...
 * @return		N/A
 */
function hmembership_admin_display_select_form_element( $args ) {
...
/**
 * hmembership_admin_display_radio_form_element
 *
 ...
 * @return		N/A
 */
function hmembership_admin_display_radio_form_element( $args ) {
